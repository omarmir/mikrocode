...
export type GitPullResult = typeof VcsPullResult.Type;
...
export const LegacyGitStatusResult = Schema.Struct({
...
export const LegacyGitListBranchesResult = Schema.Struct({
  branches: Schema.Array(GitBranch),
  isRepo: Schema.Boolean,
  hasOriginRemote: Schema.Boolean,
});

export const GitStatusResult = LegacyGitStatusResult;
export type GitStatusResult = typeof GitStatusResult.Type;

export const GitListBranchesResult = LegacyGitListBranchesResult;
